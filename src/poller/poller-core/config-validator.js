...
class ConfigValidator {
  ...
  /**
   * Validates the given object against the Memorystore Config schema.
   *
...
/**
 * Validates the specified Memorystore Autoscaler JSON configuration file.
...
/**
 * Validates all the Memorystore Autoscaler YAML config files specified in the
