...
sed -i "s|image: scaler-image|image: ${SCALER_IMAGE}|g" autoscaler-pkg/scaler/scaler.yaml
sed -i "s/minSize: 1/minSize: ${TARGET_SHARDS}/g" autoscaler-config/autoscaler-config.yaml
